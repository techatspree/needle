...
public class InjectionTargetInformation {
	...
	private InjectionTargetInformation(final Class<?> type, final AccessibleObject accessibleObject, final Annotation... parameterAnnotations) {
		this.type = type;
	...
	/**
	 * Creates an instance of {@link InjectionTargetInformation} for {@link Field} injection.
	 * 
	 * @param type
	...
	/**
	 * Creates an instance of {@link InjectionTargetInformation} for {@link Method} injection.
	 * 
	 * @param type
	...
	/**
	 * Creates an instance of {@link InjectionTargetInformation} for {@link Constructor} injection.
	 * 
	 * @param type
	 ...
	 */
	public InjectionTargetInformation(final Class<?> type, final Constructor<?> constructor, final Annotation[] parameterAnnotations) {
	 ...
	 * 
	 * If the {@link AccessibleObject} of the injection target is of type {@link Method} or {@link Constructor}, then the {@link Annotation} of the {@link AccessibleObject} and the corresponding
	...
	public Annotation[] getAnnotations() {
		...
		final Annotation[] annotations = new Annotation[accessibleObjectAnnotations.length + parameterAnnotations.length];

		System.arraycopy(accessibleObjectAnnotations, 0, annotations, 0, accessibleObjectAnnotations.length);
		System.arraycopy(parameterAnnotations, 0, annotations, accessibleObjectAnnotations.length, parameterAnnotations.length);
	...
	/**
	 * Returns the {@link Annotation} object if an annotation for the specified type is present on the injection target, otherwise null.
	 * 
	 * If the {@link AccessibleObject} of the injection target is of type {@link Method} or {@link Constructor}, then the {@link Annotation} may be specified on the {@link AccessibleObject} or on the
